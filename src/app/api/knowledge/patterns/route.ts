...
import { GET as v1GET, POST as v1POST } from '@/app/api/v1/knowledge/patterns/route'
import { proxyToV1, legacySuccessorPath } from '@/lib/deprecation-shim'

/**
 * @deprecated Use /api/v1/knowledge/patterns.
 ...
 */
const ROUTE = '/api/knowledge/patterns'
const TARGET = '/api/v1/knowledge/patterns'
