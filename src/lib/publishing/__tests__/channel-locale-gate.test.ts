// TQ-TST-07/08 — gate canal x locale (lado app; espelho do worker, ambos testados).
import { describe, it, expect } from 'vitest'
import { isChannelAllowedForLocale, assertChannelLocale, ChannelLocaleGateError } from '@/lib/publishing/channel-locale-gate'

describe('channel-locale-gate (app)', () => {
  ...
  it('assertChannelLocale lanca ChannelLocaleGateError com channel/locale', () => {
    let caught: unknown
    try {
